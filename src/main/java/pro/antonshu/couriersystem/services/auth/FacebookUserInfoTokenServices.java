package pro.antonshu.couriersystem.services.auth;
...
public class FacebookUserInfoTokenServices implements ResourceServerTokenServices {
    ...
    public OAuth2Authentication loadAuthentication(String accessToken) throws AuthenticationException, InvalidTokenException {
        ...
        System.out.println("facebookUserId: " + facebookUserId + "; facebookName - " + facebookFirstName + " " + facebookLastName);
            ...
            Client client = clientService.findByPhone(facebookUserId);

            if(client == null) {
                client = new Client();
            }

            client.setPhone(facebookUserId);
            client.setLastName(facebookLastName);
            client.setFirstName(facebookFirstName);
            client.setEmail(facebookUserMail);
